 ...
 * @public
 */
const StringFormat = exports.StringFormat = {
  /**
 ...
 * @internal
 */
const TaskEvent = exports._TaskEvent = {
  /**
   * For this event,
   * <ul>
 ...
 * @internal
 */
const TaskState = exports._TaskState = {
...
(0, _upload.upload)('#file', {
  ...
  onUpload: function onUpload(files, blocks) {
    files.forEach(function (file, index) {
      ...
      var task = (0, _storage.uploadBytes)(storageRef, file);
      var block = blocks[index].querySelector('.preview-info-progress');
      task.then(function (snapshot) {
        console.log('Загрузка завершена');
        (0, _storage.getDownloadURL)(snapshot.ref).then(function (downloadURL) {
